...
export default class DetailPane extends React.Component {
  ...
  render() {
    return (
      <div className={`container-panel ${this.props.class}`}>
        <div className="header">
          ...
          <span className="minimize-button" onClick={() => this.props.toggleDetailPane()}>
        ...
        <Tabs>
          <TabsItem value="tab1" label="Tab 1">
            <p>Detail panes are a way to provide additional detailed information about a specific visualization (tables, chart, map, etc.) on the current screen. They are triggered by parts of an interactive visualization, which requires additional content to be displayed about a specific part of the visualization.</p>
            <p>When a user has not selected anything from the visualization and the detail panel is expanded, display an empty state message with instructions for the user to know how to “fill” the content of the detail panel.</p>
          </TabsItem>
          ...
          <TabsItem value="tab3" label="Tab 3">
            <p>Dummy content: Nulla quis tortor orci. Etiam at risus et justo dignissim.</p>
