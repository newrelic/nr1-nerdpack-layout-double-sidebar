...
- A `<DetailPane />` component to use for the right sidebar.
...
3. Use the following command to clone this repository and run the code locally against your New Relic data:
